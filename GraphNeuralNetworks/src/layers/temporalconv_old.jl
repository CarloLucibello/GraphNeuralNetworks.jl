...
function (ggru::GConvGRUCell)(g::GNNGraph, x::AbstractMatrix, h::AbstractMatrix)
...
Graph Convolutional Gated Recurrent Unit (GConvGRU) recurrent layer from the paper 
