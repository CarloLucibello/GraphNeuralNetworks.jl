...
function (l::GCNConv)(g::AbstractGNNGraph, 
    ...
    GNNlib.gcn_conv(l, g, x, edge_weight, norm_fn)
end
...
function (l::GATConv)(g::AbstractGNNGraph, x, e::Union{Nothing, AbstractMatrix} = nothing)
    GNNlib.gat_conv(l, g, x, e)
end
...
function (l::GATv2Conv)(g::AbstractGNNGraph, x, e::Union{Nothing, AbstractMatrix} = nothing)
    GNNlib.gatv2_conv(l, g, x, e)
end
...
function (l::ResGatedGraphConv)(g::AbstractGNNGraph, x)
    GNNlib.res_gated_graph_conv(l, g, x)
end
...
function (l::SGConv)(g::GNNGraph, x::AbstractMatrix{T},
    ...
    GNNlib.sg_conv(l, g, x, edge_weight)
end
...
function (l::TransformerConv)(g::GNNGraph, x::AbstractMatrix,
    ...
    GNNlib.transformer_conv(l, g, x, e)
end
